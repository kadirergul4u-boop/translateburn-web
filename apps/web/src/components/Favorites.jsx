...
export default function Favorites({ favorites, onRestore, onRemove }) {
    ...
    <Sheet>
      ...
      <SheetContent className="w-full sm:max-w-md flex flex-col">
        <SheetHeader className="pb-4">
          <SheetTitle>Saved Translations</SheetTitle>
        </SheetHeader>
        ...
        <ScrollArea className="flex-1 -mx-6 px-6">
          {favorites.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-40 text-center space-y-3">
              ...
              <p className="text-sm text-muted-foreground">No saved translations yet</p>
            </div>
          ) : (
